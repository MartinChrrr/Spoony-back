...
public class TaskPostponeAdapter implements TaskPostponePort {
    ...
    /**
     * Reporte toutes les tâches actives dues le jour fromDate vers toDate.
     * Supprime également les UserTaskLog PLANNED du même jour (fromDate)
    ...
    public int postponeAllActiveTasks(UUID userId, LocalDate fromDate, LocalDate toDate) {
        // 1. Décaler la dueDate des UserTask actives dues aujourd'hui
